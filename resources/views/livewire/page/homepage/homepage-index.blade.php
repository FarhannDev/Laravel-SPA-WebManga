                                        ...
                                        <div class="position-relative overflow-hidden ">
                                            <a href="{{ route('komikShow', $latest->comic_slug) }}">
                                                <img class="img-fluid w-100 rounded"
                                                    ...
                                                    style="height: 300px;" alt="{{ $latest->comic_title }}">
                                            </a>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="position-relative overflow-hidden ">
                                                        <a href="{{ route('komikShow', $data->comic_slug) }}">
                                                            <img class="img-fluid w-100 rounded"
                                                                ...
                                                                style="height: 300px;" alt="{{ $data->comic_title }}">
                                                        </a>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card mb-3">
                            <img class="card-img-top"
                                src="{{ asset($blog->blog_cover ? 'images/blog/' . $blog->blog_cover : 'images/default.jpg') }}"
