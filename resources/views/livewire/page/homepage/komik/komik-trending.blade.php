            ...
            <div class="container px-lg-6">
                <div class="row g-5 justify-content-end align-items-center">
                    <div class="col-lg-6 text-center text-lg-start">
                        <h1 class="text-dark mb-4 animated slideInDown text-capitalize"> Cari & Temukan semua komik trending
                            saat ini
                        </h1>
                        <div class="d-flex justify-content-start">
                            <nav aria-label="breadcrumb"
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Komik Trending</li>
                                </ol>
                            </nav>
                        </div>
